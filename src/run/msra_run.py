...
def msra_run(_run, _config, _log):
    ...
    if _config["env"] == 'lbf':
        ...
        _config["env_args"]["map_name"] = "Foraging-{}x{}-{}p-{}f-s{}{}".format(
            str(field_size),
            str(field_size),
            str(players),
            str(max_food),
    ...
    if _config["env"] == 'hallway':
        ...
        _config["env_args"]["map_name"] = f"hallway-{state_str}-{nagents}p"
    ...
    if _config["env"] == "hallway_group":
        ...
        _config["env_args"]["map_name"] = f"hallway-{state_str}-{group_str}-{nagents}p"
