...
class MASIAAgent(nn.Module):
    ...
    def __init__(self, input_shape, args):
        ...
        if self.args.concat_obs:
            ...
            self.fc1 = nn.Linear(args.ob_embed_dim + self.latent_dim + args.n_agents + (args.n_actions if args.obs_last_action else 0), args.hidden_dim)
        else:
            self.fc1 = nn.Linear(self.latent_dim + args.n_agents + (args.n_actions if args.obs_last_action else 0), args.hidden_dim)
