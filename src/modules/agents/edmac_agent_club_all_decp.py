...
class EDMACClubAgent_all_decp(nn.Module):
    def __init__(self, input_shape, args):
        super(EDMACClubAgent_all_decp, self).__init__()
        self.args = args
        ...
        #dec msg aggregator
        self.diff_attn = DiffAttention(args.rnn_hidden_dim, args.msg_dim*2, args.msg_dim*2, args.attn_head_num, args.attn_embed_dim, args.diff_attn_lambda_init)
    ...
    def forward(self, inputs, hidden_state, state=None, test_mode=False, calculate_loss=False):
        ...
        msg = th.cat((msg_env,msg_dec),dim=-1)
        #dec msg aggregator
        msg_dec_copied = msg.repeat_interleave(a, dim=0)#ba,a,-1
