...
class QLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            agent_outs, extra_loss  = self.mac.forward(batch, t=t)
            # agent_outs, q_without_comm_ = self.mac.forward(batch, t=t, counterfactual=True)
            mac_out.append(agent_outs)
            extra_losses = extra_losses + extra_loss
        ...
        # Optimise
        self.mac.msg_optim.zero_grad()
        extra_losses.backward()
        self.mac.msg_optim.step()
